  ...
  return (
    <header className="site-header">
      ...
      <div className="header-status">
        <span className="phase-badge">Phase 6 · Analyst UI</span>
...
function ExecutionTrace({ steps }: { steps: ExecutionStep[] }) {
...
function ResultsPanel({
  ...
  return (
    <main className="results" aria-live="polite">
      ...
      {response.charts?.length ? <EDACharts charts={response.charts} /> : null}
